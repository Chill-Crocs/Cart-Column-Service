        ...
        <div id="shipped-grid">
          <div id="shipped-grid-0-0">
            <div id="grid-0-0-content">
              <span className="etsy-icon wt-circle wt-bg-gray">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="4 0 1 17" fill="none" aria-hidden="true" focusable="false">
          ...
          <div id="shipped-grid-0-1">
            <div id="grid-0-1-content">
              <span className="etsy-icon wt-circle wt-bg-gray">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-80 0 6 17" aria-hidden="true" focusable="false">
          ...
          <div id="shipped-grid-0-2">
            <div id="grid-0-2-content">
              <span className="etsy-icon wt-circle wt-bg-gray">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-160 0 6 17" aria-hidden="true" focusable="false">
